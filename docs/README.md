...
5. `hermes-outbound-seam-memo.md`：**[NEW]** 确定如何拦截并重定向 Hermes 的出站消息。
6. `phase-1-live-validation.md`：**[NEW]** 查看 Phase 1 现场测试的证据与通过标准。
7. `roadmap.md`：确认长期方向、阶段路线和哪些决策可以延后。
8. `git-standards.md`：确认分支、提交、PR 和历史整理规范。
9. `open-questions.md`：最后整理目前依然悬而未决的问题。
